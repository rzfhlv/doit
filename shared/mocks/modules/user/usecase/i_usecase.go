...
func (_m *IUsecase) Register(ctx context.Context, user model.User) (model.JWT, error) {
	...
	var r0 model.JWT
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, model.User) (model.JWT, error)); ok {
		return rf(ctx, user)
	}
...
func (_m *IUsecase) Validate(ctx context.Context, validate model.Validate) (*jwt.JWTClaim, error) {
	...
	var r0 *jwt.JWTClaim
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, model.Validate) (*jwt.JWTClaim, error)); ok {
		return rf(ctx, validate)
	}
